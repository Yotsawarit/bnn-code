...
Tool Call Details:
  1. glob: {"pattern":"*.md","path":"/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core"}
```
...
prompts:
  - text: |
      List all markdown files in /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core/
```
...
prompts:
  - text: |
      Use the glob tool to find all markdown files in /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core/
      
      You MUST use the glob tool like this:
      glob(pattern="*.md", path="/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core")
