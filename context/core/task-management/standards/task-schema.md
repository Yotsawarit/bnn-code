...
|-------|---------|----------|----------------|
| `context_files` | "What rules do I follow?" | Standards, conventions, patterns from `/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/` | Load and apply as coding guidelines |
