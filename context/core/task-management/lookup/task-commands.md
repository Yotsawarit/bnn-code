...
```bash
npx ts-node /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
