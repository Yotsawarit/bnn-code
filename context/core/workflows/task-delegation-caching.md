...
├── .cache/
│   ├── test-coverage.md (cached from /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/
ELSE:
  READ from /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/
  CACHE the file
```
