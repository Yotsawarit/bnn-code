  ...
  <stage id="5" name="OrganizeContext">
    ...
    <routing>
      <route to="ContextOrganizer">
        ...
        <integration>
          Write context files to /media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/ directory structure
        </integration>
      </route>
    </routing>
  ...
  <stage id="10" name="DeliverSystem">
    ...
    <output_format>
      ...
      **3. Try a Complete Workflow**:
      ...
      - **Context Organization**: `/media/pac_tz12/1c9c6a9e-8fe9-4e3b-bdb5-41056ff08bd43/home/pack/pac-station/bnn-code/context/`
